  ...
  return (
    <div id={`${fabId}-container`} className="fixed bottom-6 end-6">
      <button
        id={`${fabId}-button`}
        onClick={handleClick}
        className="flex items-center justify-center w-14 h-14 rounded-full bg-blue-500 text-white shadow-2xl drop-shadow-lg hover:bg-blue-600 active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all duration-300 transform hover:scale-105"
        aria-label="Add Item"
      >
        {children}
      </button>
